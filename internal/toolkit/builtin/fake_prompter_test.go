...
// delegates to a closure the test installs, so a spec drives the human-in-the-loop
// handlers without a terminal. A method whose closure is unset fails the spec,
